        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center mb-6">
              ...
              <h4 className="font-bold text-2xl md:text-3xl">Mantri Home Care</h4>
            </div>
            ...
            <div className="flex space-x-4 mt-6">
              ...
              {/* Facebook - SUDAH DIPERBAIKI */}
              <a 
                href="https://www.facebook.com/share/1cN4shH4VT/" 
                target="_blank" 
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="https://forms.gle/AHfTtxtUEkqvTrG36" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">
                  Daftar / Antri Layanan
                </a>
              </li>
            </ul>
          </div>
          ...
          {/* Kolom 4: Lokasi & Lainnya */}
          <div>
            <h4 className="font-bold text-xl mb-6">Lokasi & Informasi</h4>
            <ul className="space-y-4">
              <li>
                <a href="https://maps.app.goo.gl/MPo7bKF3iLcrQC8r8" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">
                  Google Maps (Ulasan)
                </a>
              </li>
              <li>
                <a href="https://maps.app.goo.gl/iUZ3vuuSrtJXeJs8A" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">
                  Lokasi Layanan Lain
                </a>
              </li>
            </ul>
