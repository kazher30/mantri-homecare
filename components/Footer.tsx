        ...
        {/* Kolom 1: Logo & Deskripsi pakai 2 kolom*/}
          <div className="md:col-span-2">
            <div className="flex items-center mb-6">
              ...
              <h4 className="font-bold text-2xl md:text-3xl mb-6">Mantri Home Care</h4>
            </div>
            ...
            <div className="flex space-x-4 mt-6">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/share/1cN4shH4VT/" target="_blank" rel="noopener noreferrer" className="bg-blue-600 rounded-full w-10 h-10 flex items-center justify-center hover:bg-blue-700 transition">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Blogger */}
              <a href="https://mantrihomecare.blogspot.com" target="_blank" rel="noopener noreferrer" className="w-auto h-10 flex items-auto justify-center">
                <img 
