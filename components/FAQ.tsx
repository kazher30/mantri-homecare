  ...
  return (
    <section id="faq" className="py-24 relative">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('/faq-background.jpg')`,
        }}
      >
        {/* Gradasi Gelap agar tulisan tetap jelas */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/75 via-black/80 to-black/90"></div>
      </div>
