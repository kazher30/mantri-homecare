  ...
  const services = [
    {
      ...
      description: 'Layanan khitan (sunat) untuk anak dan dewasa dengan metode modern yang minim nyeri, bius tanpa jarum suntik, tanpa dijahit, tanpa diperban, penyembuhan cepat, minim nyeri/pendarahan, tanpa diet khusus/pantangan, bisa langsung aktifitas seperti biasa dan bisa dipanggil ke rumah.',
    ...
    <section id="services" className="py-24 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h3 className="text-4xl md:text-5xl font-extrabold text-blue-900 mb-6">Solusi Kesehatan Medis Profesional Di Rumah Anda</h3>
